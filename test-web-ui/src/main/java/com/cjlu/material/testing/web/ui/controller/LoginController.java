package com.cjlu.material.testing.web.ui.controller;

import com.cjlu.material.testing.commons.dto.BaseResult;
import com.cjlu.material.testing.commons.utils.EmailSendUtils;
import com.cjlu.material.testing.web.ui.api.UsersApi;
import com.cjlu.material.testing.web.ui.constant.SystemConstants;
...
public class LoginController {
    ...
    public String login(TbUser tbUser, Model model, HttpServletRequest request) throws Exception {
        ...
        // 登录成功
            ...
            emailSendUtils.send("用户登录", String.format("用户 【%s】 登录 MyShop", user.getUsername()), "2011801420@qq.com");
            // 将会员信息放入 Session
